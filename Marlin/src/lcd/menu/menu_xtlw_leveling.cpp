...
static inline void _lcd_goto_next_corner() {
  ...
  switch (bed_corner) {
    case 0:
      current_position.set(25, 30);
      break;
    case 1:
      current_position.x = 180;
      break;
    case 2:
      current_position.y = 190;
      break;
    case 3:
      current_position.x = 25;
      break;
...
void menu_xtlw_leveling() {
  ...
  auto _recalc_offsets = []{
    if (active_extruder && all_axes_known()) {
  ...
  //EDIT_ITEM(float52sign, MSG_Z_OFFSET_HOME, &home_offset.z, -10.0, 2.0, _recalc_offsets);

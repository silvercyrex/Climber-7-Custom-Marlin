...
#define DUAL_X_CARRIAGE
  ...
  #define X1_MAX_POS (X_BED_SIZE - 15)  // Set a maximum so the first X-carriage can't hit the parked second X-carriage
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 35*60, 8*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
